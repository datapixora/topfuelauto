      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8 border-t pt-8">
          ...
          <div className="text-right" dir="rtl">
            <p className="mb-4">
              تاپ‌فیول‌اتو یک پلتفرم جستجوی خودرو است که اطلاعات موجود در منابع عمومی را جمع‌آوری می‌کند.
              ما خودرو نمی‌فروشیم و کارگزار نیستیم. فقط به شما کمک می‌کنیم تا آگهی‌ها را پیدا کنید و شما
              را به منبع اصلی هدایت می‌کنیم.
            </p>
            <p className="mb-4">
              با استفاده از سرویس ما، شما با این شرایط موافقت می‌کنید. ما هیچ تضمینی برای دقت یا در دسترس
              بودن اطلاعات نمی‌دهیم. سرویس "همان‌طور که هست" ارائه می‌شود. شما باید همه اطلاعات را در وب‌سایت
              اصلی بررسی کنید.
            </p>
            <p className="mb-4">
              ما محدودیت نرخ داریم و ممکن است منابع داده را فعال یا غیرفعال کنیم. استفاده نادرست ممکن است
              منجر به تعلیق حساب شود. برای سوالات، با ما تماس بگیرید.
            </p>
          </div>
        </section>
      </div>
